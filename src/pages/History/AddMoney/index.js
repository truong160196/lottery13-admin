...
const AddMoneyPage = observer(() => {
  ...
  const { mutate: onDelete, isLoading: deleteLoading } = useMutation(
    ...
    {
      onSuccess: (res) => {
        queryClient.invalidateQueries(["payment", "list_system"]);
      ...
      <div className="main-content-inner">
        <div className="page-container">
          <div className="remix-sub-header">
            <h2 className="remix-page-title">Lịch sử hệ thống</h2>
          </div>
            ...
            <div className="page-overview">
              <div className="static-number mb-24">
                <div className="card-static">
                  <p>Admin nạp tiền</p>
                  <h1>
                    {formatNumber(get(dataReport, "deposit_admin.amount", 0))}
                  </h1>
                </div>
                <div className="card-static">
                  <p>Admin trừ tiền</p>
                  <h1>
                    {formatNumber(get(dataReport, "withdraw_admin.amount", 0))}
                  </h1>
                </div>
              </div>
            </div>
