...
const CommissionPage = observer(() => {
  ...
  const { data: dataState, isLoading, refetch } = useQuery(
    ["payment", "list_commission", filters],
    () =>
      PaymentApi.getList({
        params: {
          page: 1,
  ...
  const { mutate: onDelete, isLoading: deleteLoading } = useMutation(
    ...
    {
      onSuccess: (res) => {
        queryClient.invalidateQueries(["payment", "list_commission"]);
      ...
      <div className="main-content-inner">
        <div className="page-container">
          <div className="remix-sub-header">
            <h2 className="remix-page-title">Danh sách hoa hồng</h2>
          </div>
            ...
            <div className="page-overview">
              <div className="static-number mb-24">
                <div className="card-static">
                  ...
                  <h1>
                    {formatNumber(get(dataReport, "commission.amount", 0))}
                  </h1>
                </div>
              </div>
            </div>
